...
class KNPromoSwapConfirmViewController: KNBaseViewController {
  ...
  @IBAction func confirmButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "swap_promo_confirm_confirm_tapped", customAttributes: ["pair": "\(self.viewModel.transaction.from.symbol)_\(self.viewModel.transaction.to.symbol)"])
  ...
  @IBAction func cancelButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "swap_promo_confirm_cancel_tapped", customAttributes: ["pair": "\(self.viewModel.transaction.from.symbol)_\(self.viewModel.transaction.to.symbol)"])
    self.delegate?.promoCodeSwapConfirmViewControllerDidBack()
  }
