...
class KNCreateLimitOrderViewController: KNBaseViewController {
  ...
  @IBAction func fromTokenButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_from_token_tapped", customAttributes: nil)
  ...
  @IBAction func fromTokenInfoButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_from_token_info_tapped", customAttributes: nil)
  ...
  @IBAction func toTokenButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_to_token_tapped", customAttributes: nil)
    let event = KNCreateLimitOrderViewEvent.searchToken(
      from: self.viewModel.from,
      to: self.viewModel.to,
      isSource: false,
  ...
  @IBAction func swapTokensButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_swap_2_tokens_tapped", customAttributes: nil)
  ...
  @IBAction func secondPercentageButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_50_percent_tapped", customAttributes: nil)
  ...
  @IBAction func thirdPercentageButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_100_percent_tapped", customAttributes: nil)
    self.keyboardSwapAllButtonPressed(sender)
  }

  @IBAction func suggestBuyTokenButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_suggest_buy_tapped", customAttributes: nil)
  ...
  @IBAction func submitOrderButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_submit_order_tapped", customAttributes: nil)
  ...
  fileprivate func submitOrderDidVerifyData() {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_order_did_verify", customAttributes: nil)
    let amount: BigInt = {
  ...
  @IBAction func manageOrderButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_manage_order_btn_tapped", customAttributes: ["action": "manage_order_btn_clicked"])
    if !self.validateUserHasSignedIn() { return }
  ...
  @objc func keyboardSwapAllButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_swap_all_btn_tapped", customAttributes: nil)
    self.view.endEditing(true)
  ...
  @objc func balanceLabelTapped(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_balance_label_tapped", customAttributes: nil)
    self.keyboardSwapAllButtonPressed(sender)
  }
  ...
  @objc func currentRateDidTapped(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_current_rate_label_tapped", customAttributes: nil)
  ...
  @IBAction func confirmCancelButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_continue_cancelling_btn_tapped", customAttributes: nil)
  ...
  @IBAction func noCancelButtonPressed(_ sender: Any?) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_change_rate_btn_tapped", customAttributes: nil)
    UIView.animate(withDuration: 0.16) {
      self.cancelRelatedOrdersView.isHidden = true
      self.cancelOrdersCollectionViewHeightConstraint.constant = 0.0
      self.updateRelatedOrdersView()
  ...
  @IBAction func reasonCancellingOrderButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_cancelling_why_btn_tapped", customAttributes: nil)
  ...
  @IBAction func underStandButtonPressed(_ sender: Any) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_undertand_checked", customAttributes: nil)
...
extension KNCreateLimitOrderViewController {
  ...
  fileprivate func showShouldCancelOtherOrdersIfNeeded() -> Bool {
    ...
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_show_suggest_cancel_orders", customAttributes: nil)
    return true
  }
  ...
  fileprivate func showConvertETHToWETHIfNeeded() -> Bool {
    ...
    if case .real(let account) = self.viewModel.wallet.type {
      ...
      self.delegate?.kCreateLimitOrderViewController(self, run: event)
      KNCrashlyticsUtil.logCustomEvent(withName: "lo1_show_convert_eth_weth", customAttributes: ["action": "show_convert_eth_weth"])
      return true
    }
    return false
  }
...
extension KNCreateLimitOrderViewController {
  ...
  func coordinatorUpdateSelectedToken(_ token: TokenObject, isSource: Bool, isWarningShown: Bool = true) {
    ...
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_select_token", customAttributes: ["token": token.symbol])
...
extension KNCreateLimitOrderViewController: KNLimitOrderCollectionViewCellDelegate {
  func limitOrderCollectionViewCell(_ cell: KNLimitOrderCollectionViewCell, cancelPressed order: KNOrderObject) {
    ...
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_open_cancel_order", customAttributes: nil)
...
extension KNCreateLimitOrderViewController: KNCancelOrderConfirmPopUpDelegate {
  func cancelOrderConfirmPopup(_ controller: KNCancelOrderConfirmPopUp, didConfirmCancel order: KNOrderObject) {
    KNCrashlyticsUtil.logCustomEvent(withName: "lo1_confirm_cancel", customAttributes: nil)
    self.listOrdersDidUpdate(nil)
    self.updateRelatedOrdersFromServer()
    self.updatePendingBalancesFromServer()
  }
